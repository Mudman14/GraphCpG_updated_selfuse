...
dm_parse.add_argument('--dataset_path', type=str, default="D:/y_HCC(1).npz",
...
dm_parse.add_argument('--batch_size', type=int, default=1024,
                      help='Batch size.')
...
model_parse.add_argument('--gpu', type=int, default=1,
                         help='id of used GPU.')
...
if __name__ == "__main__":
    ...
    gpu_id = args.gpu
    time_start = time()
    trainer = Trainer(logger=logger, callbacks=callbacks, max_epochs=maxepochs, limit_train_batches=limit_batch, limit_val_batches=limit_batch, limit_test_batches=limit_batch_test)
    datamodule.setup()
    time_process = time()
